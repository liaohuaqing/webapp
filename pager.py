...
class Pagination(object):
    ...
    def page_html(self):
        ...
        if self.params["page"] < 1:
            pervious_page = '<li ><a href="%s?%s">上一页</a></li>' % (self.base_url, urlencode(self.params))
        else:
            pervious_page = '<li><a href = "%s?%s"  >上一页</a></li>' % ( self.base_url, urlencode(self.params))
        ...
        if self.params["page"] > self.max_page_num:
            ...
            next_page = '<li><a href = "%s?%s" aria-label = "Next">下一页</a></li >' % (self.base_url, urlencode(self.params))
        else:
            next_page = '<li><a href = "%s?%s" aria-label = "Next">下一页</a></li>' % (self.base_url, urlencode(self.params))
