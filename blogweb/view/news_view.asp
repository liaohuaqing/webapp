...
newscontent=replace(newscontent,"^S^","&lt;SCRIPT") 
newscontent=replace(newscontent,"^T^","SCRIPT&gt;") 
'newscontent=replace(newscontent,"&lt;br&gt;","")
newscontent=replace(newscontent,"(pre)","<div><pre class=brush:js;>")
newscontent=replace(newscontent,"(/pre)","</pre></div>")
...
<meta name="keywords" content="<%=newsname%>" />
    ...
    <div id="content">
       <!--left-->
         <div class="left" id="news">
           <div class="weizi">
           <div class="wz_text">当前位置：<a href="../default.asp">首页</a>><a href="../list.asp?id=<%=class_id%>"><%=ft_classname%></a>><span>文章内容</span></div>
           </div>
           ...
           <div class="news_content">
                  <div class="news_top">
                    <h1><%=newsname%></h1>
                    <p>
                      <span class="left sj">时间:<%=newsdate%></span><span class="left fl">分类:<%=ft_classname%></span>
