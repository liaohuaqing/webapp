...
<tr>
  <td align="right" class="a3">文章内容<p><font color="#FF0000">源码标签+(+&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	+)+</font></td>
  <td colspan="2" class="a3">  <textarea id="Content" name="Content" style="width:95%;height:300px;">
...
content=addHTML(RemoveHTML(content))
...
<tr>
  <td align="right" class="a3">文章内容<p><font color="#FF0000">源码标签+(+&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	+)+</font></td>
  <td colspan="2" class="a3"><textarea id="Content" name="Content" style="width:95%;height:300px;"><%=content2%>
...
<% 
Function RemoveHTML(strHTML)    '过滤HTML代码的函数
StrHtml = Replace(StrHtml,"<pre>","&|3")
StrHtml = Replace(StrHtml,"</pre>","&|4")
StrHtml = Replace(StrHtml,"<br>","&^1")
StrHtml = Replace(StrHtml,"<br />","&^2")
StrHtml = Replace(StrHtml,"<p>","")
StrHtml = Replace(StrHtml,"</p>","")
StrHtml = Replace(StrHtml,chr(39)," &acute; ") '替换单引号
StrHtml = Replace(StrHtml,chr(34)," &quot; ")    '替换双引号
StrHtml = Replace(StrHtml,"SCRIPT","^S1^")
StrHtml = Replace(StrHtml,"script","^S1^")
StrHtml = Replace(StrHtml,"<SCRIPT","^S^") 
StrHtml = Replace(StrHtml,"SCRIPT>","^T^") 

StrHtml = Replace(StrHtml,"<","&lt; ")    '替换<
StrHtml = Replace(StrHtml,">"," &gt;")    '替换>

StrHtml = Replace(StrHtml,"&^1","")
StrHtml = Replace(StrHtml,"&^2","")
'StrHtml = Replace(StrHtml,"&|1","<p>")  
'StrHtml = Replace(StrHtml,"&|2","</p>")
StrHtml = Replace(StrHtml,"&|3","<pre>")
StrHtml = Replace(StrHtml,"&|4","</pre>")  
RemoveHTML=strHTML   
Set objRegExp = Nothing   
End Function  
 
Function AddHTML(strHTML)    '加HTML代码的函数
StrHtml = Replace(StrHtml,"&|3","<pre>")
StrHtml = Replace(StrHtml,"&|4","</pre>")
StrHtml = Replace(StrHtml,"<br>","&^1")
StrHtml = Replace(StrHtml,"<br />","&^2")
...
StrHtml = Replace(StrHtml," &acute; ",chr(39)) '替换单引号
StrHtml = Replace(StrHtml," &quot; ",chr(34))    '替换双引号

StrHtml = Replace(StrHtml,"^S^","<SCRIPT") 
StrHtml = Replace(StrHtml,"^T^","SCRIPT>") 
StrHtml = Replace(StrHtml,"^S1^","SCRIPT")
StrHtml = Replace(StrHtml,"&lt; ","<")    '替换<
StrHtml = Replace(StrHtml," &gt;",">")    '替换>
